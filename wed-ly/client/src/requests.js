...
class Requests {
  //Get Tasks
  //following code block is grabbed and used to help solve this issue of connecting or making requests to my backend using VueJS from https://github.com/bradtraversy/microposts_fullstack_vue. He helpfully goes over how I could make requests to my backend using this code.
